...
df = pd.read_csv('C:/Users/This PC/Downloads/LMS_Portal-main/qa/students.csv')
...
def parse_question(question):
    ...
    if "info" in question or "details" in question:
        ...
        response = f"{['darshak']}'s Maths marks: {student.maths}"
    elif "science" in question:
        response = f"{['darshak']}'s Science marks: {student.science}"
    elif "social" in question:
        response = f"{['darshak']}'s Social marks: {student.social}"
    elif "email" in question:
        response = f"{['darshak']}'s Email: {student.email}"
